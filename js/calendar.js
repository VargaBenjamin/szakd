...
$(document).ready(function() {
  ...
  if (coachidOpt == '') {
    ...
    $('#alert').html('Sajnos nincs mit megjeleníteni.. Lépj be a beállításaidba, válassz ki egy edzőtermet és egy edzőt!');
  } else {
    $.ajax({
